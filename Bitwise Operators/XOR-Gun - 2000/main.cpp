...
//notice that any 3 numbers with the biggest bit consecutively are going to give us a sol = 1
//by pigeon hole principle this can only happen 2*MAX_BITS (then on 61 it wil happen) so 2*30 (ceil(log10^9/log2)) = 60 so n>60 = 1 we can js brute force a n^3 solution after that frfr
// there we go (prefxor!)
